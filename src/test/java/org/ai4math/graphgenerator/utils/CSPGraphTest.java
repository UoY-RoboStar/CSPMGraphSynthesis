...
public class CSPGraphTest {
    ...
    @Test
    void givenInitialVerticesAddedButInitialNotIndicated_whenGetInitialVertex_thenReturnRandomInitialVertex() throws IOException {
        CSPGraph g = new CSPGraph();
    ...
    @Test
    void givenNoInitialVerticesAddedButInitialNotIndicated_whenGetInitialVertex_thenReturnRandomInitialVertex() throws IOException {
        CSPGraph g = new CSPGraph();

        CSPVertex x1 = new CSPVertex("x1", false);
        CSPVertex x2 = new CSPVertex("x2");
        CSPVertex x3 = new CSPVertex("x3");
