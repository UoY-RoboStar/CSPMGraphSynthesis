...
public class CommandLineOptionsTest {
    ...
    public void givenAllValidArgs_whenParseCommandLine_thenReturnAccurateOptions() throws IOException, ParseException {
        String[] args = {"-p", "test path", "-b", "4", "-c", "500", "-r", "-d", "-v", "2", "-re"};
        ...
        assertTrue(clo.getGraphGenerationOptions().isVersion2());
        assertTrue(clo.getGraphGenerationOptions().isDecorations());
        assertTrue(clo.getGraphGenerationOptions().isRenaming());
    }
    ...
    public void givenOnlyRequiredArgs_whenParseCommandLine_thenReturnAccurateOptions() throws IOException, ParseException {
        ...
        assertFalse(clo.getGraphGenerationOptions().isDecorations());
        assertFalse(clo.getGraphGenerationOptions().isRenaming());
        assertFalse(clo.getGraphGenerationOptions().isVersion2());
    }
    ...
    public void givenInvalidArgs_whenParseCommandLine_thenThrowError() throws IOException, ParseException {
        @SuppressWarnings("unchecked")
        String[] args = {"-p", "test path", "-b", "4", "-c", "x", "-re", "-d", "-r"};
